# Operator Quickstart — Motion picture, video and television programme distribution activities

Shortest path from clone to a verified local dry-run for **ISIC 5913** (`cloud-itonami-isic-5913`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-5913.git
cd cloud-itonami-isic-5913
```
...
- Blueprint governor key: `film-distribution-governor`
- Likely source path: `filmdistops.governor.cljc`
